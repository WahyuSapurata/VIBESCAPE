                        ...
                        <div class="mb-1">
                            ...
                            <div class="position-relative mb-3">
                                <div class="position-relative">
                                    <input placeholder="Password" type="password" name="current_password" autocomplete="off"
                                        class="form-control" />
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data User');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/data-user-add', 'Tambah',
                    'Data User',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/data-user-edit/' + uuid,
                    'Update',
                    'Data User', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/data-user-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Data User', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/data-user-delete/' + $(this).attr('data-uuid');
            ...
            $('#kt_table_data').DataTable({
                ...
                columns: [{
                    ...
                    render: function(data, type, row) {
                        ...
                        const createdAt = new Date(row.updated_at).toLocaleString('id-ID', {
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data User" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
