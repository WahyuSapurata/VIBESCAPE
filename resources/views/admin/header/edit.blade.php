                            ...
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/header/{{ $data->thumbnail }})">
                                ...
                                <div class="mb-10">
                                    <label class="form-label">Deskripsi <i><small>(opsional)</small></i></label>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/update-header/' + lastPart,
