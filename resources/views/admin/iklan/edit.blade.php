                        ...
                        <div class="card-body hover-scroll-overlay-y">
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" id="judul_iklan" class="form-control" name="judul_iklan"
                                        value="{{ $data->judul_iklan }}">
                                    <small class="text-danger judul_iklan_error"></small>
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/iklan/{{ $data->thumbnail }})">
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/update-iklan/' + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            ...
                            .then(function() {
                                window.location.href = '/admin/iklan';
                            });
                    } else {
                        $("form")[0].reset();
