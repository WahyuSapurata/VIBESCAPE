    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <!--begin::Brand-->
                <div class="aside-logo flex-column-auto" style="background-color: #193030;">
                    <!--end::sidebar mobile toggle-->
                    <!--begin::Mobile logo-->
                    <div class="app-sidebar-logo d-flex align-items-center flex-grow-1 flex-lg-grow-0"
                        id="kt_app_sidebar_logo">
                        <a href="" class="full-logo">
                            <img alt="Logo" src="{{ asset('LOGO vibescape_logotype putih.png') }}"
                                class="mw-75 h-sm-auto app-sidebar-logo-default" />
                            <img alt="Logo" src="{{ asset('LOGO vibescape_putih.png') }}"
