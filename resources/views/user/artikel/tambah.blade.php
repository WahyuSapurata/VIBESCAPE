                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-body hover-scroll-overlay-y">
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    <div>
                                        <label for="thumbnail" class="form-label">Thumnail</label>
                                    </div>
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        ...
                                        <label
                                            ...
                                            data-bs-dismiss="click" title="Change Thumnail">
                                        ...
                                        <span
                                            ...
                                            data-bs-dismiss="click" title="Cancel Thumnail">
                                        ...
                                        <span
                                            ...
                                            data-bs-dismiss="click" title="Remove Thumnail">
                                            <i class="bi bi-x fs-2"></i>
                                        </span>
                                        <!--end::Remove button-->
                                    </div>
...
@section('script')
    <script>
        ...
        $(function() {
            control.push_select3(data, null, '#from_select_kategori');
        });
    </script>
@endsection
