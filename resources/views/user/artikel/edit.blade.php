                        ...
                        <div class="card-body hover-scroll-overlay-y">
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" id="judul_artikel" class="form-control" name="judul_artikel"
                                        value="{{ $data->judul_artikel }}">
                                    <small class="text-danger judul_artikel_error"></small>
                                </div>

                                <div class="mb-10">
                                    <label class="form-label">Kategori</label>
                                    <select name="kategori" class="form-select" data-control="select2"
                                        value="{{ $data->kategori }}" id="from_select_kategori"
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea id="konten" name="konten" value="{{ $data->konten }}">{{ $data->konten }}</textarea>
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/thumbnail/{{ $data->thumbnail }})">
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/user/update-artikel/' + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            ...
                            .then(function() {
                                window.location.href = '/user/artikel';
                            });
                    } else {
                        $("form")[0].reset();
        ...
        const data = [{
            ...
            {
                text: "Feature Eksklusif"
            },
            {
                text: "Wawancara Eksklusif"
            },
            {
                text: "Startup"
            },
        ...
        $(function() {
            control.push_select3(data, '{{ $data->kategori }}', '#from_select_kategori');
        });
    </script>
@endsection
