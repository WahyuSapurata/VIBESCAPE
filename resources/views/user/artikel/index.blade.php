...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            window.location.href = '/user/add-artikel';
        })

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            window.location.href = '/user/edit-artikel/' + $(this).attr('data-uuid');
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/user/delete-artikel/' + $(this).attr('data-uuid');
        ...
        $(document).on('click', '.button-publikasi', function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: '/user/publikasi-artikel/' + $(this).attr('data-uuid'),
                contentType: false,
                processData: false,
                success: function(response) {
                    $(".text-danger").html("");
